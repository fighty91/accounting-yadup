...
const RowFormOpeningBalance = (props) => {
    ...
    const {row, account, accounts, formValidation, parentAccounts, accountTransactions} = props.data
    ...
    return(
        <tr>
            ...
            <td>
                ...
                <input type="text" name="debit" id={'db-'+row} min={0} className={`form-control form-control-sm text-end debit ${nominalProblem === true && 'border-danger'} account-value`} onChange={handleEntryInputNumb} onFocus={handleFocusInputNumb} onBlur={handleBlurInputNumb} onKeyUp={handleKeyEnter} autoComplete="off" />
            ...
            <td>
                ...
                <input type="text" name="credit" id={'cr-'+row} min={0} className={`form-control form-control-sm credit text-end ${nominalProblem === true && 'border-danger'} account-value`} onChange={handleEntryInputNumb} onFocus={handleFocusInputNumb} onBlur={handleBlurInputNumb} onKeyUp={handleKeyEnter} autoComplete="off" />
            </td>
            <td>
...
export default RowFormOpeningBalance