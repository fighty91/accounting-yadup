...
const RowFormReceiptJournal = (props) => {
    ...
    const {row, account, accounts, description, credit, formValidation, parentAccounts, accountTransactions} = props.data
    ...
    return(
        <tr>
            ...
            <td>
                ...
                onKeyUp={handleKeyEnter} autoComplete="off" title={credit} />
...
export default RowFormReceiptJournal