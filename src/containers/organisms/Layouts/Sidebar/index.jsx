    ...
    const handleActiveBarAndTitle = () => {
        ...
        switch(segmentTemp) {
            ...
            case 'receipt-journal':
                newSegment.receiptJournalActive = true
                document.title = 'Receipt Journal'
                break
    ...
    return (
        <Fragment>
            <svg xmlns="http://www.w3.org/2000/svg" style={{display: "none"}}>
                ...
                <symbol id="receipt-svg" viewBox="0 0 16 16">
                ...
                <div className="offcanvas-md offcanvas-end bg-body-tertiary" tabIndex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto w3-sidebar">
                        <ul className="nav flex-column">
                            ...
                            <li className="nav-item">
                                <Link to="/receipt-journal" className={`nav-link d-flex align-items-center gap-2 link-secondary ${segment.receiptJournalActive && 'active'}`} >
                                    <svg className="bi"><use xlinkHref="#receipt-svg"/></svg>
                                    Receipt Journal
                                </Link>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <Link to="/reports" className={`nav-link d-flex align-items-center gap-2 link-secondary ${segment.reportActive && 'active'}`} >
                                    <svg className="bi"><use xlinkHref="#graph-up"/></svg>
                                    Reports
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/accounts" className={`nav-link d-flex align-items-center gap-2 link-secondary ${segment.accountActive && 'active'}`} >
