        ...
        <Fragment>
            ...
            <main className="form-signin w-100 m-auto py-5 my-5">
                ...
                <div className="text-start mb-3">
                    ...
                    { userNull && <InputValidation name="input empty!!" /> }
                ...
                </div>
                {
                    props.authLoading ?
                        ...
                        <button className="btn btn-primary w-100 py-2" onClick={handleSubmit}>Register</button>
                }
                <div className="text-start my-3">
                    Have account ready ? <Link to="/login">Go to login</Link>
                </div>
